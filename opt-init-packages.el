...
(defvar jkw:el-get-package-list-from-recipe
  '(ace-jump-mode ag all-ext anzu auto-async-byte-compile cl-lib-highlight color-moccur
                  cssm-mode dired+ e2wm e2wm-bookmark eldoc-extension emmet-mode
                  ...
                  moccur-edit monokai-emacs multiple-cursors org-mode php-align php-mode
                  psvn rainbow-mode recentf-ext region-bindings-mode scratch-ext
