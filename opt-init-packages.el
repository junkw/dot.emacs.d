...
(defvar jkw:el-get-package-list-from-recipe
  '(ace-jump-mode ag all-ext anzu auto-async-byte-compile cl-lib-highlight color-moccur
                  ...
                  flycheck geben gist git-gutter-fringe goto-chg grep-a-lot helm-c-yasnippet
                  helm-descbinds helm-migemo highlight-symbol info+ js2-mode linum-relative
                  lispxmp magit migemo moccur-edit monokai-emacs multiple-cursors org-mode
                  php-align php-mode psvn rainbow-mode recentf-ext region-bindings-mode
                  scratch-ext sequential-command smartrep tern twittering-mode viewer
                  web-mode wgrep)
