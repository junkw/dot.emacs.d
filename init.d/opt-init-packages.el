...
(defvar jkw:el-get-package-list-from-recipe
  '(ace-isearch ace-jump-mode ace-window ag all-ext anzu auto-async-byte-compile
                ...
                flycheck geben gist git-gutter-fringe goto-chg helm helm-ag
                helm-c-yasnippet helm-descbinds helm-migemo helm-swoop highlight-symbol
                info+ js2-mode linum-relative lispxmp magit markdown-mode migemo
                monokai-emacs multiple-cursors mykie org-mode php-completion php-mode
                psvn rainbow-mode recentf-ext scratch-ext sequential-command smart-newline
                smartrep tern twittering-mode viewer web-mode wgrep)
